...
public class GameApp {
	...
	public static void main(String[] args){
		...
		if (userCharacter.getPlaying() == true) {//if the user choses to play, set playing to true
			...
			if(menuChoice.equalsIgnoreCase("1")) {//user has chosen to create a character
					...
					if(menuChoice.equalsIgnoreCase("1")) {// manual input ability score
						...
						int intel = key.nextInt();
						System.out.println("Enter your charmisa: ");
						int charisma = key.nextInt();
						AbilityScore a = new AbilityScore(str,wis,dex,con,intel,charisma);
